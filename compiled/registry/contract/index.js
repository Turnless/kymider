...
export var BorrowStatus;
(function (BorrowStatus) {
  BorrowStatus[BorrowStatus['UNREGISTERED'] = 0] = 'UNREGISTERED';
  BorrowStatus[BorrowStatus['ACTIVE'] = 1] = 'ACTIVE';
  BorrowStatus[BorrowStatus['SUSPENDED'] = 2] = 'SUSPENDED';
...
const _descriptor_2 = new _BorrowerRecord_0();
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      updateCommitment: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(instanceAddr_0).concat(_descriptor_0.toValue(commitment_0)),
    ...
    this.impureCircuits = {
      ...
      updateCommitment: this.circuits.updateCommitment,
      suspend: this.circuits.suspend
    };
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('updateCommitment', new __compactRuntime.ContractOperation());
    state_0.setOperation('suspend', new __compactRuntime.ContractOperation());
